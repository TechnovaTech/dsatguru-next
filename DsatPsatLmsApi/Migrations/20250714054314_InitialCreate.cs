    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseHighlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseHighlights_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZoomSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ZoomSessions_CourseSchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "CourseSchedules",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ZoomSessions_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_CourseEnrollments_EnrollmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseHighlights_CourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ZoomSessions_CourseId",
                table: "ZoomSessions",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ZoomSessions_ScheduleId",
                table: "ZoomSessions",
                column: "ScheduleId");
        }
