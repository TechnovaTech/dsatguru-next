...
import featureImage from "../../../../dsat-psat-lms-frontend-student/src/assets/feature.jpg";
      ...
      >
        <div className="w-full h-full flex items-center justify-center">
          <img
            ...
            className="w-full h-64 md:h-80 object-cover rounded-xl shadow-md shadow-gray-400"
          />
        </div>
      </motion.div>
    </div>
