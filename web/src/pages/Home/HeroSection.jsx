...
import Hero1Img from "../../../../dsat-psat-lms-frontend-student/src/assets/hero-1.png";
import Hero2Img from "../../../../dsat-psat-lms-frontend-student/src/assets/hero-2.png";
import Hero3Img from "../../../../dsat-psat-lms-frontend-student/src/assets/hero-3.png";
...
const slidesData = [
  ...
  },
  {
    ...
    description:
      "High-quality DSAT preparation that fits your budget. Access the same elite resources used by top scorers without the premium price tag, making excellence accessible to all.",
    features: [
  ...
  },
  {
    ...
    description:
      "Prepare for the Digital SAT format with confidence. Our specialized tools simulate the exact testing environment and question types you'll encounter on exam day.",
    features: [
...
const HeroSection = ({ landingPlanRef }) => {
