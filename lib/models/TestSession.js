...
const testSessionSchema = new mongoose.Schema({
  ...
  // Raw bank selector as chosen in the UI — may be a real questionBankId OR a synthetic
  // bucket id ('admin-math','admin-rw','tutor-math',...). questionBankId is a strict
  // ObjectId and CastErrors on the synthetic ids, so those are carried here as a string
  // and resolved to a Mongo filter via lib/bankFilter.resolveBankFilter().
  bankSelector: { type: String },
  subject: { type: String },
