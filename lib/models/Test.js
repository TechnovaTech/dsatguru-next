...
const testSchema = new mongoose.Schema({
  ...
  owner: { type: mongoose.Schema.Types.ObjectId, ref: 'User' }, // Creator of a self-practice test
  isSelfPractice: { type: Boolean, default: false }, // Student-generated practice (never listed in admin/assigned catalogs)
