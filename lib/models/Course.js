...
const courseMeetingSchema = new mongoose.Schema({
  ...
  // Guest (no-account) access for demo classes, trials and parents. Off by
  // default. `code` is the unguessable half of the shared link; guests always
  // land in the waiting room, so a forwarded link still cannot walk in.
  guestAccess: {
