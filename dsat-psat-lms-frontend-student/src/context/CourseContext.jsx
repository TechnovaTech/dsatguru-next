...
import { getCourses } from "../services/api/courseManagement";
...
export const CourseProvider = ({ children }) => {
  ...
  // Build the Individual Tutoring fallback card
  ...
  const refreshCourses = async () => {
    ...
    try {
      ...
      const formatted = res.data.map((course, index) => {
        console.log(`Course ${course.title} highlights:`, course.highlights);
        ...
        return {
          ...
          priceNote: '',
          // Explicitly sort highlights by sequenceOrder to ensure correct order
      ...
      console.error(err);
      // Graceful offline fallback so UI can render without backend
