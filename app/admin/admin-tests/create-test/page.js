...
export default function CreateAdminTest() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token')
      // Submit to Admin Tests manual endpoint
      const res = await fetch('/api/admin/admin-tests/manual', {
        method: 'POST',
        headers: { 
      ...
      setTimeout(() => {
        router.push('/admin/admin-tests/test-sheets')
      }, 2000)
        ...
        {!showQuestionSelector ? (
          <>
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-1">Create a custom test from the Admin Question Bank</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., SAT Math Practice 1"
              ...
              <div>
                ...
                >
                  Select Questions from Admin Question Bank
                </button>
