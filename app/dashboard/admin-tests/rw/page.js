  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8 font-[Poppins]">
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Reading & Writing Admin Practice</h1>
          ...
          {activeTab === 'Assigned' && (
            history.filter(h => h.status === 'Assigned').length > 0 ? (
              ...
              <div className="text-center py-16 bg-white rounded-lg border border-dashed border-gray-300">
                ...
                <p className="text-gray-500 text-sm mt-1">You don&apos;t have any pending Reading & Writing admin tests.</p>
              </div>
            )
          )}
